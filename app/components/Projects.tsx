...
const projects = [
  {
    ...
    description:
      "Desarrollo del sitio web oficial de Parque Tempisque, parque empresarial y tecnológico de Costa Rica. Implementación completa con WordPress y Elementor Pro, optimizado para SEO y rendimiento.",
    tags: ["WordPress", "Elementor Pro", "SEO", "UI/UX"],
    url: "https://www.parquetempisque.com/",
    hasLink: false,
    comingSoon: true,
    demoUrl: "https://pt-test-demo.webflow.io/",
    demoLabel: "Ver Demo de Webflow",
    year: "2026",
  ...
  {
    id: "02",
    title: "Sistema CoWork",
    subtitle: "Plataforma de Gestión de Espacios",
    description:
      "Sistema integral para alquiler y solicitud de espacios de CoWorking en Parque Tempisque. Incluye panel de administración, gestión de reservas y dashboard de métricas.",
    tags: ["Next.js", "MongoDB", "React", "Node.js", "Tailwind CSS"],
    url: "#",
    hasLink: false,
    year: "2026",
    category: "Full Stack",
